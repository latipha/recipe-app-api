...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_delete_recipe(self):
        """Test deleting recipe is successul."""
        recipe = create_recipe(user=self.user)
        url = detail_url(recipe.id)
    ...
    def test_delete_other_users_recipe_error(self):
        """Test trying to delete another users recipe givers error."""
        new_user = create_user(email='user2@exmaple.com', password='testpass')
    ...
    def test_create_recipe_with_ingredients(self):
        ...
        payload = {
            'title': 'Caulifliower Tacos',
            'time_minutes': 60,
            'price': Decimal('4.50'),
            'ingredients': [{'name': 'Caulifliower'}, {'name': 'Salt'}]
        }
